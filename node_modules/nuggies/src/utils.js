...
module.exports.giveawayEmbed = async (client, { host, prize, endAfter, winners, requirements }) => {
	...
	const embed = new Discord.MessageEmbed()
		.setTitle('Çekiliş! 🎉')
		.setDescription(`**Çekilişe katılmak için tıkla!**\n🎁 Ödül: **${prize}**\n🎊  ${hoster} tarafıdan oluşturuldu. \n`)
		.setColor('RANDOM')
		.setFooter('Bitiş:', 'https://cdn.discordapp.com/emojis/843076397345144863.png?v=1')
...
module.exports.dropEmbed = async (client, { prize, host }) => {
	...
	const embed = new Discord.MessageEmbed()
		.setTitle('Drop! 🎉')
		.setDescription(`**İlk tıklayan kişi kazanır!**\n🎁 Ödül: **${prize}**\n🎊  ${hoster} tarafıdan oluşturuldu. \n`)
		.setColor('RANDOM')
		.setFooter('kazanan: none');
	return embed;
};
